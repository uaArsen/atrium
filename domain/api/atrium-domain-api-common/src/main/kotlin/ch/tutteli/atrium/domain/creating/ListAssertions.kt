...
interface ListAssertions {
    fun <T: Any> get(plant: AssertionPlant<out List<T>>, index: Int, assertionCreator: AssertionPlant<T>.() -> Unit): Assertion
    fun <T> getNullable(plant: AssertionPlant<out List<T>>, index: Int, assertionCreator: AssertionPlantNullable<T>.() -> Unit): Assertion
}
