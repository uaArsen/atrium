...
class MapAssertionsSpec : ch.tutteli.atrium.spec.integration.MapAssertionsSpec(
    ...
    containsInAnyOrderOnlyFun.name to Assert<Map<String, Int>>::enthaeltUngeordnetNur,
    containsInAnyOrderOnlyNullableFun.name to Assert<Map<String?, Int?>>::enthaeltNullableUngeordnetNur,
    ...
    companion object {
        ...
        private val containsInAnyOrderOnlyFun : KFunction3<Assert<Map<String, Int>>, Pair<String, Int>, Array<out Pair<String, Int>>, Assert<Map<String, Int>>> = Assert<Map<String, Int>>::enthaeltUngeordnetNur
        private val containsInAnyOrderOnlyNullableFun : KFunction3<Assert<Map<String?, Int?>>, Pair<String?, Int?>, Array<out Pair<String?, Int?>>, Assert<Map<String?, Int?>>> = Assert<Map<String?, Int?>>::enthaeltNullableUngeordnetNur
